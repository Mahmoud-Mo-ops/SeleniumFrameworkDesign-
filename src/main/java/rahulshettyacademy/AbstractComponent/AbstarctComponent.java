...
public class AbstarctComponent {
	...
	public void waitForElementToAppear(By findBy) {
		...
		// WebElement element =
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("myButton")));
	}
	...
	public void waitForElementTodisappear(WebElement ele) throws InterruptedException {
		...
		// ==
		// wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("loadingSpinner"))));
